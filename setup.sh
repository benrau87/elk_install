...
#Java and deps
apt install -y openjdk-8-jre apt-transport-https wget oracle-java8-installer nginx apache2-utils -y 
...
curl -L -O https://artifacts.elastic.co/downloads/beats/filebeat/filif [ "$EUID" -ne 0 ]
  then echo "Please run as root"
  exit
fi
